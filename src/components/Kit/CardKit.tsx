...
export const CardKit: React.FC<CardKitProps> = ({ kit }) => {
    ...
    return (
        ...
        >
            <FormGroup sx={{ width: isMobile ? "18%" : "fit-content" }}>
                <FormControlLabel
                    checked={kit.active}
            ...
            <Box
                sx={{ flexDirection: "row", width: "100%", alignItems: "center", justifyContent: "space-between" }}
            ...
            >
                ...
                <ArrowForwardIos
                    ...
                    onClick={() =>
                        navigate(user?.isAdmin ? `/adm/settings-kit/${kit.id}` : `/employee/settings-kit/${kit.id}`)
                    }
                />
            </Box>
        </Box>
